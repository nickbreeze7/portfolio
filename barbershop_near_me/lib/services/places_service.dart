...
/*
  Future<List<Place>>  getPlaces777(double lat, double lng, double radius) async {
  ...
  Future<List<Place>> getPlaces(double lat, double lng, double radius) async {
    // String keyword1 = Uri.encodeComponent('바버');
    // String keyword2 = Uri.encodeComponent('barber');
