...
import 'package:flutter_movies_app/widgets/colored_circle.dart';
import 'package:flutter_movies_app/widgets/drawer_item.dart';
  ...
  Widget build(BuildContext context) {
   return Drawer(
     child: Container(
       color: kPrimaryColor,
       child: Padding(
         padding: EdgeInsets.only(top: 10.h, left: 6.w, right: 6.w, bottom: 5.h),
         child: Column(
