package com.breezenick.whatappclone2021.requests;
...
public class RequestsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        databaseReferenceRequests
                = FirebaseDatabase.getInstance().getReference().child(NodeNames.FRIEND_REQUESTS).child(currentUser.getUid());
                            ...
                            databaseReferenceUsers.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if(dataSnapshot.child(NodeNames.NAME).getValue() != null){
                                        userName = dataSnapshot.child(NodeNames.NAME).getValue().toString();
                                    }
                                ...
                                public void onCancelled(@NonNull DatabaseError databaseError) {
                                    Toast.makeText(getActivity(),
                                            getString(R.string.failed_to_fetch_friend_requests,
