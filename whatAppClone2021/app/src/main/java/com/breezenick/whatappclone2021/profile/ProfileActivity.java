package com.breezenick.whatappclone2021.profile;
...
import com.breezenick.whatappclone2021.login.LoginActivity;
import com.breezenick.whatappclone2021.password.ChangePasswordActivity;
        ...
        firebaseUser.updateProfile(request).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ProfileActivity.this,
                            getString(R.string.failed_to_update_profile, task.getException()),
                            Toast.LENGTH_SHORT).show();
                }
            }
