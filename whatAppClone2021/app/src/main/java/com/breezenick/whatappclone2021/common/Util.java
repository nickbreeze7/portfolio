package com.breezenick.whatappclone2021.common;
...
public class Util {
                                          ...
                                          final String message, String userId)
    {
       ...
       public  static  void  sendNotification999(final Context context, final String title , final String message , String userId){
            DatabaseReference rootRef =
                    FirebaseDatabase.getInstance().getReference();

            DatabaseReference databaseReference =
                    rootRef.child(NodeNames.TOKENS).child(userId);
            ...
            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    String deviceToken =
                            dataSnapshot.child(NodeNames.DEVICE_TOKEN).getValue().toString();
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest =
                                new JsonObjectRequest(fcmApiUrl , notification,
                                                    successListener, failureListener){
                                    @Override
                                    public Map<String, String> getHeaders() throws AuthFailureError {
                                        Map<String, String> params = new HashMap<>();
                                        ...
                                        //params로 안하니까  notifications가 안됐음.20200711
                                        return params;
                                    }
                                };
       ...
       public  static  void updateChatDetails(final Context context , final String currentUserId ,
            ...
            DatabaseReference chatRef = rootRef.child(NodeNames.CHATS).child(chatUserId)
                    .child(currentUserId);
