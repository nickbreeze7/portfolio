...
import 'package:flutter_movies_app_clone01/model/movie_preview.dart';
import 'package:flutter_movies_app_clone01/secret/themoviedb_api.dart' as secret;
import 'package:flutter_movies_app_clone01/utils/constants.dart';
import 'package:flutter_movies_app_clone01/utils/file_manager.dart';
...
class MovieModel {
  ...
  Future<MovieDetails> getMovieDetails({required String movieID}) async {
    var data = await _getData(
      url:
          '$kThemoviedbURL/$movieID?api_key=${secret.themoviedbApi}&language=ko-KR',
    );
